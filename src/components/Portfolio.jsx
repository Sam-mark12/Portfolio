...
const Portfolio = () => {
  ...
  const portfolios = [
    ...
    { id: 6, src: apple, add: "apple developed with NEXTJS and TailwindCSS, featuring clone of website integration." },
    { id: 7, src: landing, add: "landing developed with React and TailwindCSS, featuring database  integration." }
  ];
  ...
  <div key={id} className='relative group animate-fadeIn'> {/* Add the animate-fadeIn class here */}
